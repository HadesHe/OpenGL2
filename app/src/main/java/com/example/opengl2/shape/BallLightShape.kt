...
import com.example.opengl2.util.*
 ...
 */
class BallLightShape(context: Context, val shape: Shape, val mR: Float) : RenderAble(context) {

    private var muMMatrixHandle: Int = 0
    private var maLightLocationHandle: Int = 0
    private var maNormal: Int = 0
    ...
    private fun initProgram() {
        val vertexShader = GLUtil.loadVertexShaderAssets(context, "balllight.vert")
        val fragmentShader = GLUtil.loadFragShaderAssets(context, "balllight.frag")
        ...
        maNormal = GLES20.glGetAttribLocation(mProgram, "aNormal")
    ...
    override fun draw(mvpMatrix: FloatArray) {
        ...
        GLES20.glVertexAttribPointer(maNormal, 3, GLES20.GL_FLOAT, false, 3 * 4, mVertexBuffer)
