...
import com.example.opengl2.shape.Hexagon
import javax.microedition.khronos.egl.EGLConfig
import javax.microedition.khronos.opengles.GL10

class HexagonView(context: Context) : BaseGL2View(context) {
    override fun getRender(): Renderer {
        return HexagonRender()
    }

    inner class HexagonRender:Renderer{
...
//            Matrix.translateM(mOpMatrix, 0, currDeg/360f, 0f, 0f)
        ...
        override fun onSurfaceChanged(gl: GL10?, width: Int, height: Int) {
            ...
            Matrix.setLookAtM(mViewMatrix, 0, 2f, 2f, -5f, 0f, 0f, 0f, 0f, 1f, 0f)

        }

        override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
            GLES20.glClearColor(1.0f, 0f, 0f, 1.0f)
            mCube = Hexagon(context)
        }
